  ...
  const shareQR = async () => {
    try {
      const response = await fetch(
        "https://raw.githubusercontent.com/avmaurya07/MAK_Doctor_Plus/refs/heads/main/public/upi_1741692439227.png"
      );
      ...
      {showQR && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-80 text-center">
            ...
            <img
              src="https://raw.githubusercontent.com/avmaurya07/MAK_Doctor_Plus/refs/heads/main/public/upi_1741692439227.png"
              alt="QR Code"
